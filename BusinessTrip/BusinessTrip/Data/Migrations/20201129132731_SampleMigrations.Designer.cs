...
namespace BusinessTrip.Data.Migrations
{
    ...
    [Migration("20201129132731_SampleMigrations")]
    partial class SampleMigrations
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BusinessTrip.Models.ApplicationStatement", b =>
                {
                    ...
                    b.Property<int?>("TypeOfBusinessTripId")
                        .IsRequired()
                        .HasColumnType("int");

                    b.Property<int?>("TypeOfSalaryRetentionId")
                        .IsRequired()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TypeOfBusinessTripId");

                    b.HasIndex("TypeOfSalaryRetentionId");
            ...
            modelBuilder.Entity("BusinessTrip.Models.ApplicationStatementFile", b =>
                {
                    ...
                    b.HasAlternateKey("FileId", "StatementId");

                    b.ToTable("AspStatementFile");
                });

            modelBuilder.Entity("BusinessTrip.Models.ApplicationStatmentTypeOfBusiness", b =>
                {
                    ...
                    b.Property<int?>("ApplicationStatementStatementId")
                        .HasColumnType("int");

                    b.Property<string>("TypeOfBusinessName")
                        .IsRequired()
                        .HasColumnType("nvarchar(50)")
                        .HasMaxLength(50);

                    b.HasKey("TypeOfBusinessId");

                    b.HasIndex("ApplicationStatementStatementId");

                    b.ToTable("AspStatmentTypeOfBusiness");
                });

            modelBuilder.Entity("BusinessTrip.Models.ApplicationStatmentTypeOfSalaryRetention", b =>
                {
                    b.Property<int>("TypeOfSalaryRetentionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("TypeOfSalaryRetentionName")
                        .IsRequired()
                        .HasColumnType("nvarchar(50)")
                        .HasMaxLength(50);

                    b.HasKey("TypeOfSalaryRetentionId");

                    b.HasIndex("ApplicationStatementStatementId");

                    b.ToTable("AspStatmentTypeOfSalaryRetention");
                });
            ...
            modelBuilder.Entity("BusinessTrip.Models.ApplicationStatement", b =>
                {
                    b.HasOne("BusinessTrip.Models.ApplicationStatmentTypeOfBusiness", "TypeOfBusiness")
                        .WithMany()
                        .HasForeignKey("TypeOfBusinessTripId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BusinessTrip.Models.ApplicationStatmentTypeOfSalaryRetention", "TypeOfSalary")
                        .WithMany()
                        .HasForeignKey("TypeOfSalaryRetentionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("BusinessTrip.Models.ApplicationStatmentTypeOfBusiness", b =>
                {
                    b.HasOne("BusinessTrip.Models.ApplicationStatement", null)
                        .WithMany("TypesOfBusiness")
                        .HasForeignKey("ApplicationStatementStatementId");
                });

            modelBuilder.Entity("BusinessTrip.Models.ApplicationStatmentTypeOfSalaryRetention", b =>
                {
                    b.HasOne("BusinessTrip.Models.ApplicationStatement", null)
                        .WithMany("TypesOfSalaryRetention")
                        .HasForeignKey("ApplicationStatementStatementId");
                });
